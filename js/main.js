...
function changeAllNameCities(value) {
...
UI.CITIES.LIST.addEventListener('click', e => {
   ...
   if (isNameCity) {
      clickNameCity(e, content)
      addWeatherCards(content.textContent)
      changeAllNameCities(content.textContent)
   }
   if (isBtnCity) {
